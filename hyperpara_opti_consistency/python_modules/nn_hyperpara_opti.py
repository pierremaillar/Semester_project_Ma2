...
def cross_val_score(hyperparam_dict, train_loader, val_inputs, val_labels,output_dim, device):
...
def optimize_hyperparameters_nn(train_inputs, train_labels, val_inputs, val_labels, number_batch,output_dim, param_grid):
    ...
    for hyperparams in all_hyperparams:
        ...
        mean_f1, std_f1 = cross_val_score(dict(zip(param_grid.keys(), hyperparams)), train_loader, val_inputs, val_labels,output_dim,device)
