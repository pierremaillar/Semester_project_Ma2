...
#best f1 score
#best_params_nn = {'layer_dim': 64, 'number_hidden_layer': 4, 'dropout_prob': 0.2, 'l2_regu': 1e-05, 'weight_decay': 0.0001, 'learning_rate': 0.0001, 'batch_size': 64, 'num_epochs': 10}
#best consistency 
best_params_nn = {'layer_dim': 64, 'number_hidden_layer': 3, 'dropout_prob': 0.3, 'l2_regu': 1e-05, 'weight_decay': 0.0001, 'learning_rate': 0.0001, 'batch_size': 64, 'num_epochs': 10}
...
#save data
np.savetxt('output/mean_BEA.txt', mean_values)
np.savetxt('output/std_BEA.txt', std_values)
...
plt.title('Relevant scores BEA', color='white')
...
plt.savefig('output/Postitionrelevance_BEA.png', dpi=200)
...
Modify_PDB_file(input_pdb, relevant_scores, "BEA")
