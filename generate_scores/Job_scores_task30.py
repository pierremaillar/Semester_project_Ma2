...
#save data
np.savetxt('output/mean_task30.txt', mean_values)
np.savetxt('output/std_task30.txt', std_values)
...
plt.title('Relevant scores task30', color='white')
...
plt.savefig('output/Postitionrelevance_task30.png', dpi=200)
